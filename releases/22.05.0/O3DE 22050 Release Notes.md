...
* Templates "Default component template" A new template is available to help you create components. Use the `o3de` CLI script and the `create-from-template` command to start a runtime component from the **DefaultComponent** template. Detailed instructions can be found in [Creating a Component in O3DE](https://www.o3de.org/docs/user-guide/programming/components/create-component/). Added via https://github.com/o3de/o3de/pull/8462
