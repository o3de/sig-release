...
* ROS2 Gem: fixed bugs multiple bugs in ROS2Clock and joint manipulator; removed not working Python tests  
...
* Proposed an RFC to add curated and uncurated lists of remote repositories to the project manager, improving discoverability.  
...
* Add Pass::ChangeConnection \- Adds a new method: Pass::ChangeConnection. Used to change how an Input or InputOutput slot is connected to a slot from a different pass.  
...
* Non-compositional Universal Scene Description geometry and animation support  
...
* Galib to do a pass on extra repo and add any gaps.
...
* O3DE may crash when creating projects using some reserved keywords as the project name (e.g. “project”). This will be addressed in a future point release.  
...
* Hidden entities may reappear at editor restart \- [https://github.com/o3de/o3de/issues/18863](https://github.com/o3de/o3de/issues/18863) (targeted for point release)
