...
Description|Type|Send To|Example Message
--|--|--|--
Notify marketing committee that the feature list is posted.|Discord|#marketing-committee|Hi. The 23.05.0 Feature list is posted at https://github.com/o3de/sig-release/blob/main/releases/23.05.0/23050%20feature%20list.md Please review the feature list to get a sense of what's in the release and follow along as this file is updated. This list will eventually become the release notes. 
...
Description|Type|Send To|Example Message
--|--|--|--
Notify O3DE Marketing that release is available|Discord|#marketing-committee|O3DE 2305 Release Messaging O3DE 23.05.0 The release is now available to download and it is ok to proceed with any marketing activities.
